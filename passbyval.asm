...
; This is an Assembly programs that implements pass-by-value to determine the LCD or GCF of two-digit numbers.
...
calculate_gcf:
    ...
    .gcf_done:
        mov [ebp + 16], eax ;GCF Result store in eax
        pop ebp
        ret
...
.lcd:
    ...
    ; Calculate the LCD using a function
	push dword [firstnum]
...
.gcf:                       ; Display the GCF prompt
    ...
    ; Calculate the GCF using a function
    push dword [firstnum]
    push dword [secondnum]
    call calculate_gcf
    add esp, 8
